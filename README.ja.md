...
- **フローテンプレートライブラリ** - 58+の公式テンプレートを専用ページで閲覧・検索、既存フローからテンプレートを作成しプラットフォーム全体で共有可能
...
- **多言語サポート** - 英語、繁体字中国語、日本語の完全なインターフェース（2,050+の翻訳キー）
- **OpenAPIドキュメント** - 200+のAPIエンドポイントを完全にドキュメント化したSwagger UI内蔵
