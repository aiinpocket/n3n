...
class GeminiNodeHandlerTest {

    private GeminiNodeHandler handler;

    @BeforeEach
    void setUp() {
        handler = new GeminiNodeHandler(new ObjectMapper());
    }
    ...
    class BasicProperties {
        ...
        @Test
        void getType_returnsGemini() {
            assertThat(handler.getType()).isEqualTo("gemini");
        }

        @Test
        void getDisplayName_containsGemini() {
            assertThat(handler.getDisplayName()).contains("Gemini");
        }
        ...
        @Test
        void getIcon_returnsGemini() {
            assertThat(handler.getIcon()).isEqualTo("gemini");
        }

        @Test
        void getCredentialType_returnsGoogle() {
            assertThat(handler.getCredentialType()).isEqualTo("google");
        }
    }
    ...
    class ResourceTests {
        ...
        @Test
        void getResources_containsModelsResource() {
            Map<String, ResourceDef> resources = handler.getResources();
            assertThat(resources).containsKey("models");
        }
    ...
    class Validation {
        ...
        void execute_missingResource_fails() {
            ...
            config.put("operation", "generateContent");
