...
class OpenAINodeHandlerTest {

    private OpenAINodeHandler handler;

    @BeforeEach
    void setUp() {
        handler = new OpenAINodeHandler(new ObjectMapper());
    }
    ...
    class BasicProperties {
        ...
        @Test
        void getType_returnsOpenai() {
            assertThat(handler.getType()).isEqualTo("openai");
        }

        @Test
        void getDisplayName_containsOpenAI() {
            assertThat(handler.getDisplayName()).contains("OpenAI");
        }
        ...
        @Test
        void getIcon_returnsOpenai() {
            assertThat(handler.getIcon()).isEqualTo("openai");
        }

        @Test
        void getCredentialType_returnsOpenai() {
            assertThat(handler.getCredentialType()).isEqualTo("openai");
        }
    }
    ...
    class ResourceTests {
        ...
        void getResources_containsChatResource() {
            ...
            assertThat(resources).containsKey("chat");
        }

        @Test
        void getResources_containsImageResource() {
            Map<String, ResourceDef> resources = handler.getResources();
            assertThat(resources).containsKey("image");
        }

        @Test
        void getResources_containsEmbeddingResource() {
            Map<String, ResourceDef> resources = handler.getResources();
            assertThat(resources).containsKey("embedding");
        }
    ...
    class Validation {
        ...
        void execute_missingResource_fails() {
            ...
            config.put("operation", "createCompletion");
