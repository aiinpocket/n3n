...
public class RedisNodeHandler extends MultiOperationNodeHandler {
    ...
    public NodeExecutionResult executeOperation(
        ...
        try {
            ...
            return switch (resource) {
                case "string" -> executeStringOperation(commands, operation, params);
                case "hash" -> executeHashOperation(commands, operation, params);
                case "list" -> executeListOperation(commands, operation, params);
                case "set" -> executeSetOperation(commands, operation, params);
                case "sortedSet" -> executeSortedSetOperation(commands, operation, params);
                case "key" -> executeKeyOperation(commands, operation, params);
                case "pubsub" -> executePubSubOperation(commands, operation, params);
    ...
    private NodeExecutionResult executeStringOperation(
    ...
    private NodeExecutionResult executeHashOperation(
        RedisCommands<String, String> commands,
        String operation,
        Map<String, Object> params
    ) throws Exception {
    ...
    private NodeExecutionResult executeListOperation(
        RedisCommands<String, String> commands,
        String operation,
        Map<String, Object> params
    ) throws Exception {
    ...
    private NodeExecutionResult executeSetOperation(
        RedisCommands<String, String> commands,
        String operation,
        Map<String, Object> params
    ) throws Exception {
    ...
    private NodeExecutionResult executeSortedSetOperation(
        RedisCommands<String, String> commands,
        String operation,
        Map<String, Object> params
    ) throws Exception {
    ...
    private NodeExecutionResult executeKeyOperation(
        RedisCommands<String, String> commands,
        String operation,
        Map<String, Object> params
    ) throws Exception {
    ...
    private NodeExecutionResult executePubSubOperation(
        RedisCommands<String, String> commands,
        String operation,
        Map<String, Object> params
    ) throws Exception {
