...
export const nodeTypes: NodeTypeConfig[] = [
  ...
  {
    value: 'fileSystem',
    label: 'nodeTypes.fileSystem.label',
    color: '#eb2f96',
    icon: 'FolderOutlined',
    description: 'nodeTypes.fileSystem.description',
    category: 'files',
  },
  {
    value: 'pdfGenerator',
    label: 'nodeTypes.pdfGenerator.label',
    color: '#eb2f96',
    icon: 'FilePdfOutlined',
    description: 'nodeTypes.pdfGenerator.description',
    category: 'files',
  },
  {
    value: 'imageResize',
    label: 'nodeTypes.imageResize.label',
    color: '#eb2f96',
    icon: 'PictureOutlined',
    description: 'nodeTypes.imageResize.description',
    category: 'files',
  },
  {
    value: 'imageConvert',
    label: 'nodeTypes.imageConvert.label',
    color: '#eb2f96',
    icon: 'FileImageOutlined',
    description: 'nodeTypes.imageConvert.description',
    category: 'files',
  },
  {
    value: 'logger',
    label: 'nodeTypes.logger.label',
    color: '#722ed1',
    icon: 'FileTextOutlined',
    description: 'nodeTypes.logger.description',
    category: 'tools',
  },
  {
    value: 'sslCheck',
    label: 'nodeTypes.sslCheck.label',
    color: '#722ed1',
    icon: 'SafetyCertificateOutlined',
    description: 'nodeTypes.sslCheck.description',
    category: 'tools',
  },
  {
    value: 'sms',
    label: 'nodeTypes.sms.label',
    color: '#fa8c16',
    icon: 'MessageOutlined',
    description: 'nodeTypes.sms.description',
    category: 'messaging',
  },
  {
    value: 'firebase',
    label: 'nodeTypes.firebase.label',
    color: '#fa8c16',
    icon: 'NotificationOutlined',
    description: 'nodeTypes.firebase.description',
    category: 'messaging',
  },
  {
    value: 'awsS3',
    label: 'nodeTypes.awsS3.label',
    color: '#13c2c2',
    icon: 'CloudUploadOutlined',
    description: 'nodeTypes.awsS3.description',
    category: 'cloud',
  },
  {
    value: 'salesforce',
    label: 'nodeTypes.salesforce.label',
    color: '#13c2c2',
    icon: 'CloudOutlined',
    description: 'nodeTypes.salesforce.description',
    category: 'cloud',
  },
  {
    value: 'convertFile',
